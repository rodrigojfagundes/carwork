package io.github.rodrigojfagundes.carwork.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	private static final String[] POST_WORK = { "/works" };
	
	private static final String[] VISITOR_AND_MEMBER = { "/car/**", "works/**", 
			"clients/**" };
	...
	public void configure(HttpSecurity http) throws Exception {
		//Configuracao para liberar o H2
		...
		.antMatchers(HttpMethod.POST, POST_WORK).hasRole("MEMBER")
